...
import { estimatePagesForStudyMinutes } from '@/services/roadmapEstimates';
...
export function DailyObjectives({
  ...
  const studyProfile = useStudyStore((s) => s.studyProfile);
              ...
              <View className="flex-row items-start gap-md">
                ...
                <View className="flex-1">
                  ...
                  <View className="flex-row gap-md mt-sm">
                    ...
                    {estimatedPages !== null && (
                      <View className="flex-row items-center gap-[4px]">
                        <NucleoIcon name="book-open" size={12} />
                        <Text className="text-text-muted text-xs font-medium">{estimatedPages} pages</Text>
                      </View>
                    )}
